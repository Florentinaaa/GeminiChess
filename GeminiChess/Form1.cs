...
namespace GeminiChess
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox_Click(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    {
                        labelBlackCapturedPieces.Text += gameController.GetCurrentPlayerName();
                        labelBlackMoves.Text += gameController.GetCurrentPlayerName();
                        stopFlag = false;
                    }
                }
        ...
        {
            if (string.IsNullOrEmpty(textBoxIpAddressServer.Text) && string.IsNullOrEmpty(textBoxWhitePlayerServer.Text))
            {
            ...
            else
            {
                ...
                {
                    uIBoard = new PictureBox[Utils.NUMBER_OF_ROWS, Utils.NUMBER_OF_COLLUMNS];
                    gameController = new GameController(textBoxWhitePlayerServer.Text, textBoxIpAddressServer.Text);
                    gameController.ConnectToServer();
                    gameController.BuildBoard();
                    buildUIBoard();
                    onlineMode = true;
     
                    labelWhiteCapuredPieces.Text += textBoxWhitePlayerServer.Text;
                    labelWhiteMoves.Text += textBoxWhitePlayerServer.Text;
